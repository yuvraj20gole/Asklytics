...
try:
    ...
    # Render sometimes reports only "Exited with status 3" for import-time failures.
    # Force the real error into logs.
    print("[BOOT] Import failure in app.main:", file=sys.stderr)
    traceback.print_exc()
    raise exc
